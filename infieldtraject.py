...
data4 = np.loadtxt("0normal.txt",comments="#",delimiter=";")
data5 = np.loadtxt("sym_rates.txt",comments="#",delimiter=";")
plt.plot(data[:,0],data[:,1],marker=".",label="hook is left")
plt.plot(data2[:,0],data2[:,1],marker=".",label="hook is right")
plt.plot(data3[:,0],data3[:,1],marker=".",label="hook is left c=0")
plt.plot(data4[:,0],data4[:,1],marker=".",label="hook is right c=0")
