...
# data0_05 = np.loadtxt("rectangle0_05.txt",comments="#",delimiter=";")
# data0_1 = np.loadtxt("rectangle0_1.txt",comments="#",delimiter=";")
# data0_2 = np.loadtxt("rectangle0_2.txt",comments="#",delimiter=";")
...
# plt.plot(data0_05[:,0],data0_05[:,1],marker=".",label="hook=nx/2 a=0.05")
# plt.plot(data0_1[:,0],data0_1[:,1],marker=".",label="hook=nx/2 a=0.1")
# plt.plot(data0_2[:,0],data0_2[:,1],marker=".",label="hook=nx/2 a=0.2")
# plt.plot(data0_3[:,0],data0_3[:,1],marker=".",label="hook=nx/2 a=0.3")
# plt.plot(data0_5[:,0],data0_5[:,1],marker=".",label="hook=nx/2 a=0.5")
# plt.plot(data0_7[:,0],data0_7[:,1],marker=".",label="hook=nx/2 a=0.7")
# plt.plot(data[:,0],data[:,1],marker=".",label="hook=nx/2 a=1")
# plt.plot(data100[:,0],data100[:,1],marker=".",label="hook=nx/2 a=100")
...
data = np.loadtxt("inhook.txt",comments="#",delimiter=";")
# data1 = np.loadtxt("1inhook.txt",comments="#",delimiter=";")
# data01 = np.loadtxt("01inhook.txt",comments="#",delimiter=";")
# data02 = np.loadtxt("01outhook.txt",comments="#",delimiter=";")
data1 = np.loadtxt("outhook.txt",comments="#",delimiter=";")

plt.plot(data[:,0],data[:,1],marker=".",label="in hook")
# plt.plot(data01[:,0],data01[:,1],marker=".",label="in hook a=0.01")
# plt.plot(data02[:,0],data02[:,1],marker=".",label="out hook a=0.01")
plt.plot(data1[:,0],data1[:,1],marker=".",label="out hook")
plt.hlines(0,xmin=-1.5,xmax=1.5,colors="black")
plt.vlines(0,ymin=-0.3,ymax=0.3,colors="black")

plt.xlim([-0.1, 1.5])
plt.ylim([-0.15, 0.35])
plt.title("dt=0.01, a=0.5, c=1, tmax=5")
plt.legend()
plt.savefig("inhook_vs_outhook.png",dpi=190)
plt.show()
